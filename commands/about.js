...
client.on('ready', async() => {
    ...
    embed.setDescription('The Best Bot of All Time')
    embed.addFields(
        ...
        { name: "Alternate Projects (they suck)", value: "[Precipitation.rb](https://discord.com/api/oauth2/authorize?client_id=1082791237662281808&permissions=8&scope=bot) - created by Idk837384#8148", inline: true}
    )
