...
client.on('messageDelete', async function(message) {
	...
	.addFields(
		...
		{ name: "Message Time", value: "<t:" + parseInt(message.createdTimestamp / 1000, 10) + "> (" + parseInt(message.createdTimestamp / 1000, 10) + ")" })
	.setColor("RED")
...
client.on('messageUpdate', function(oldMessage, newMessage) {
	...
	.addFields(
		...
		{ name: "Message Time", value: "<t:" + parseInt(oldMessage.createdTimestamp / 1000, 10) + "> (" + parseInt(oldMessage.createdTimestamp / 1000, 10) + ")" })
	.setColor("YELLOW")
	.setTimestamp()
...
client.on('guildMemberAdd', async function(member) {
	...
	.addFields({ name: "Account Dates", value: "**Creation Date**: " + member.user.createdAt.toUTCString() + "\n**Join Date**: " + member.joinedAt.toUTCString()})
	.setColor(host.color)
