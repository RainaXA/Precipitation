/* ========================================================================= *\
    Fraud/Swap!: Swap! mode for the social deduction game based on faking your identity!
...
let fs = require('fs')
if(!fs.existsSync('./commands/deduction.js')) log("Could not find a command to start Fraud games. This module may be dysfunctional.", logging.warn, "swap")
